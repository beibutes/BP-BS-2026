...
const CATALOG = [
  ...
  { match: ["наушники", "bose", "sony"], id: "headphones", emoji: "🎧", title: "Sony WH-1000XM6",
    desc: "Накладные наушники с шумоподавлением — для перелётов.", img: IMG("photo-1505740420928-5e560c06d30e") },
  ...
  { match: ["dji", "osmo"], id: "dji-camera", emoji: "🎥", title: "DJI Osmo Pocket 3",
    desc: "Карманная камера со стабилизацией для путешествий.", img: IMG("photo-1473968512647-3e447244af8f") },
  { match: ["шахмат"], id: "smart-chess", emoji: "♟️", title: "GoChess (умные шахматы)",
    desc: "Умная доска: ходит сама и помогает учиться игре.", img: IMG("photo-1528819622765-d6bcf132f793") },
  ...
  { match: ["rimowa", "bellroy", "чемодан"], id: "luggage", emoji: "🧳", title: "Чемодан Rimowa",
    desc: "Премиальный чемодан для поездок.", img: IMG("photo-1553062407-98eeb64c6a62") },
